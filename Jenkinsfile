pipeline {
  ...
  environment {
    ...
    NAMESPACE = "@eeacms"
    SONARQUBE_TAGS = "volto.eea.europa.eu,climate-energy.eea.europa.eu,forest.eea.europa.eu,biodiversity.europa.eu,water.europa.eu-freshwater,water.europa.eu-marine,industry.eea.europa.eu,demo-www.eea.europa.eu,www.eea.europa.eu-en,climate-adapt.eea.europa.eu,insitu.copernicus.eu"
      ...
      when {
        anyOf {
          allOf {
            ...
            environment name: 'CHANGE_TARGET', value: '4.x.x'
          }
          allOf {
            environment name: 'CHANGE_ID', value: ''
            anyOf {
